      ...
      <div class="bg-gray-800 rounded-xl p-8 shadow-xl border border-gray-700">
        ...
        <div class="mb-8">
          ...
          <div @click="triggerAudioInput"
            ...
            <div v-if="!audioFile">
              <svg class="w-10 h-10 text-gray-500 mx-auto mb-2 group-hover:text-blue-400" fill="none"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div>
            ...
            <div @click="triggerCoverInput"
              ...
              <!-- 移除按钮 -->
              <button v-if="coverFile" @click.stop="removeCover"
                class="absolute top-2 right-2 p-1 bg-red-600 rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <!-- 3. 上传按钮 -->
        <button @click="upload" :disabled="!audioFile || uploading"

package com.kyf.mp.server.modules.user.service.workflow;
...
class UsersWorkflowTest {
    ...
    void setUp() {
        ...
        usersWorkflow = new UsersWorkflow(new UsersRepositoryImpl(usersMapper));
        ReflectionTestUtils.setField(usersWorkflow, "userCoverUrl", "/static/user-covers/");
        ReflectionTestUtils.setField(usersWorkflow, "userCoverPath", "target/test-user-covers");
    }
    ...
    void rejectsMissingUser() {
        ...
        BusinessException exception = assertThrows(BusinessException.class,
                () -> usersWorkflow.editUserProfile(new EditUserDTO(), 1L));
    ...
    void doesNotUpdateWhenNothingChanged() {
        ...
        EditVO result = usersWorkflow.editUserProfile(new EditUserDTO(), 1L);
    ...
    void updatesUserName() {
        ...
        EditVO result = usersWorkflow.editUserProfile(dto, 1L);
    ...
    void rejectsTakenUserName() {
        ...
        BusinessException exception = assertThrows(BusinessException.class,
                () -> usersWorkflow.editUserProfile(dto, 1L));
